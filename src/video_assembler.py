...
def _generar_subtitulos(items):
    ...
    lines = [
        ...
        "Style: Default,DejaVu Sans,58,&H00FFFFFF,&H000000FF,&H00000000,&H80000000,1,0,0,0,100,100,0,0,1,4,0,2,40,40,160,1",
        "Style: Hook,DejaVu Sans,66,&H00FFFFFF,&H000000FF,&H00000000,&H80000000,1,0,0,0,100,100,0,0,1,5,0,2,40,40,160,1",
        "Style: Punch,DejaVu Sans,66,&H0000FFFF,&H000000FF,&H00000000,&H80000000,1,0,0,0,100,100,0,0,1,5,0,2,40,40,160,1",
        "[Events]",
